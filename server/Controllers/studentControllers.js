...
const updateStudent = (req, res) => {
    const {Address, Division, Email, FirstName, LastName, Id, Medium, Phone, RollNumber, StandardId, Gender} = req.body;
    const IsActive = 1;
    const user = {
        FirstName: FirstName,
        LastName: LastName,
...
module.exports = { getStudentById, getStudentBySchool, getStudentByStandard, getStudentBySubject, updateStudent }